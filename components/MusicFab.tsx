...
const MusicFab = forwardRef<MusicFabHandle>((_, ref) => {
  ...
  useEffect(() => {
    audioRef.current = new Audio("https://bsjoelxktbvlavfoozhk.supabase.co/storage/v1/object/public/fotos-clientes/audio/xv-magy/cancion.mp3");
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        inset: -8,
        borderRadius: "50%",
        border: "1.5px solid rgba(209,157,1,0.30)",
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 8,
          borderRadius: "50%",
          background: "linear-gradient(135deg, #d19d01, #a67c01)",
        ...
        <div style={{
          ...
          width: 2,
          height: 22,
          background: "linear-gradient(to bottom, #d19d01 0%, rgba(209,157,1,0.50) 100%)",
          borderRadius: 2,
      ...
      <button
        ...
        style={{
          ...
          overflow: "hidden",
          boxShadow: "0 4px 24px rgba(90,33,112,0.50), 0 0 0 1.5px rgba(209,157,1,0.26)",
        }}
      >
        {/* Spinning disc */}
        <div style={{
          ...
          background: `
            ...
            radial-gradient(circle, #d19d01 0%, #a67c01 17%, #a87d00 19%, transparent 19.5%),
        ...
        <div style={{
          ...
          <svg width="19" height="19" viewBox="0 0 24 24" fill="rgba(209,157,1,0.95)">
